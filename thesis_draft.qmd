...
Usually the above object is paired with `tune_cluster` as seen in the previous K-means example, however cross-validation is not currently implemented for FIM.
...
## Future Directions
The `tune` package relies on the `dials` package [@kuhn_dials_2024] 
# References
