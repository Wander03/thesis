...
The remaining sections of this thesis will be dedicated to the examination of the design and implementation choices made while implementing FIM in `tidyclust.` Chapter 3 details each step of the workflow and Chapter 4 addresses current limitations and proposed enhancements.
...
\addcontentsline{toc}{chapter}{\uppercase{References}}
\newpage
